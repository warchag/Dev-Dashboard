...
export default function SystemStats() {
  ...
  const mainDisk =
    disk && disk.length > 0
      ? disk.reduce((prev, current) => (prev.size > current.size ? prev : current))
      : null
  ...
  const defaultInterface =
    networkInterfaces?.find((net) => !net.internal && net.ip4 && net.operstate === 'up') ||
    networkInterfaces?.[0]
        ...
        >
          ...
          {cpuTemperature?.main && cpuTemperature.main > 0 && (
            <div
              style={{
                background:
                  cpuTemperature.main > 75 ? 'var(--accent-orange)' : 'rgba(255,255,255,0.1)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            <div
              style={{
                ...
                height: '80px',
                borderRadius: '50%',
                background: `conic-gradient(var(--accent-blue) ${cpuPercent}%, rgba(255,255,255,0.05) 0)`,
                display: 'flex',
                alignItems: 'center',
            ...
            <div>
              <p style={{ color: 'var(--text-main)', fontWeight: '600', marginBottom: '4px' }}>
                {cpu.cpus?.[0]?.model?.split(' @')[0] || osInfo.distro || 'Processor'}
              </p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            <div
              style={{
                ...
                height: '80px',
                borderRadius: '50%',
                background: `conic-gradient(var(--accent-green) ${memPercent}%, rgba(255,255,255,0.05) 0)`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center'
              }}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          <div
            style={{
              ...
              height: '80px',
              borderRadius: '50%',
              background: `conic-gradient(var(--accent-orange) ${diskPercent}%, rgba(255,255,255,0.05) 0)`,
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center'
            }}
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'var(--text-main)', fontWeight: 'bold' }}>
              {time?.uptime ? formatUptime(time.uptime) : 'N/A'}
            </span>
          </div>
        </div>
            ...
            topProcesses.map((p, idx) => (
              ...
              >
                ...
                <span
                  style={{
                    textAlign: 'right',
                    color: p.cpu > 50 ? 'var(--accent-orange)' : 'var(--text-main)'
                  }}
                >
                  {p.cpu.toFixed(1)}%
                </span>
